...
class ConfOpt(Enum):  # An Enum with frozen data items for values is used for convenience for scope/iteration
    ...
    LOCATION = ConfOptDef(
        ...
        help=QT_TR_NOOP('Latitude, Longitude for solar elevation calculations.'))
...
class VduControlsConfig:
    ...
    def enable_unsupported_vcp_code(self, vcp_code: int) -> None:
        self.ini_content[ConfSec.VDU_CONTROLS_WIDGETS][f'unsupported-{vcp_code}'] = 'yes'  # TODO this seems incorrect?
