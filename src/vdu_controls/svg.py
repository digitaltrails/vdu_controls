...
AUTO_LUX_OFF_SVG = AUTO_LUX_ON_SVG.replace(SVG_AUTO_LUX_LED_COLOR, SVG_AUTO_LUX_OFF_LED_COLOR)
...
VDU_PRESET_EDIT_ICON_SVG = load_svg_source('vdu_preset_edit_icon.svg')
