...
2021-2026 Contributors to vdu_controls <https://github.com/digitaltrails/vdu_controls>
-->
...
The `Vdu_controls` _Light-Metering-Dialog_ includes controls for setting
...
![Default](images/light-meter-1.png)
...
## Arduino Light Meter + GY30/GY302/BH1750 
...
![Default](images/light-meters-arduino-gy30.jpg)
...
See the  [vdu_controls manual](manuual)
