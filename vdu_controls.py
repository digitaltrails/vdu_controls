...
def translate(source_text: str, disambiguation: str = None):
    ...
    5) Install completed .qm files to $HOME/.config/vdu_controls/translations/
...
LOCALE_TRANSLATIONS_PATHS = (Path.cwd().joinpath("translations"), Path(CONFIG_DIR_PATH).joinpath('translations'),
