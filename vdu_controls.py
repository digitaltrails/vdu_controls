...
class DdcutilInterfaceQtDBus(QObject):
    ...
    def __init__(self, common_args: List[str] = []):
        ...
        if len(self.common_args) != 0:
            self._validate(self.ddcutil_proxy.call("Restart",
...
LUX_DUSK_SVG = b"""<?xml version="1.0" encoding="utf-8"?>
<!-- Generator: Adobe Illustrator 22.0.1, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
         viewBox="0 0 30 30" style="enable-background:new 0 0 30 30;" xml:space="preserve">
    <style type="text/css" id="current-color-scheme"> .ColorScheme-Text { color:#232629; } </style>
...
class VduAppWindow(QMainWindow):
    ...
    def create_main_control_panel(self) -> None:
        ...
        if self.main_controller.lux_auto_controller is not None:
            ...
            if lc_extra := self.main_controller.lux_auto_controller.create_manual_input_control():
                extra_controls.append(lc_extra)
